...
export const metadata: Metadata = {
  title: { default: "DevPulse — GitHub activity, made readable", template: "%s · DevPulse" },
  description: "Turn any public GitHub profile into an activity dashboard and a shareable developer portfolio page.",
};
